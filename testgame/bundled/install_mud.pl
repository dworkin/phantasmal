...
print "To run the MUD, try typing \"start_mud\" or \"./start_mud\".  If that\n";
print "doesn't work then type \"bin\\driver.exe $filename\" on Windows, or\n";
print "\"bin/driver $filename\" on Unix.\n";
