...
system("c:\\cygwin\\bin\\find $outdir -name CVS -type d -print > $outdir/distrib_tmp.txt");
...
system("c:\\cygwin\\bin\\find $outdir -name README -exec rm \\{\\} ;");
system("c:\\cygwin\\bin\\find $outdir -name .cvsignore -exec rm \\{\\} ;");
...
system("c:\\cygwin\\bin\\find . -name \"*~\" -exec rm \\{\\} ;");
system("c:\\cygwin\\bin\\find . -name \"#*\" -exec rm \\{\\} ;");
system("c:\\cygwin\\bin\\find . -name \".#*\" -exec rm \\{\\} ;");
